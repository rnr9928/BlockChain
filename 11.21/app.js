...
// 요놈 먼저치고 실행
// geth --datadir node --http --http.addr "0.0.0.0" --http.port 8000 --http.corsdomain "*" --http.api "admin,miner,txpool,web3,personal,eth,net" --syncmode full --networkid 12345
...
// geth --networkid 12345 console 2 --rpc --rpcport 8000 --rpcaddr 127.0.0.1
// geth --datadir ./myDataDir --networkid 12345 console 2 --rpc --rpcport 8000 --rpcaddr 127.0.0.1